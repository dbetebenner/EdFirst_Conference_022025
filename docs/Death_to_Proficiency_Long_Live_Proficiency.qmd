...
<!--
#########################################
Section: Cards on the Table
#########################################
-->

# {background-image=assets/img/cards_on_the_table.jpg background-size="cover" background-position="center" .no-logo}

---

## {background-image=assets/img/cards_on_the_table.jpg background-size="cover" background-position="center" background-opacity=0.3}

<h2>My Cards</h2><i class="fa-solid fa-cards"></i>

- After attending numerous sessions here in Dallas, one item of consensus I see is that no one is satisfied with the status quo of accountability systems.
- In terms of solutions, there is as much disagreement as there is consensus on the first point.
- I too believe that the current state of accountability systems is unsatisfactory. But for different reasons than most.
- I don't believe we've used the high quality data from state summative assessments correctly for the past 20 years. 
- My position is somewhat conservative: Part of the failure of accountability systems to fulfill their promise stems from a lack of coherence in the design of the systems.
- In this presentation I want to step back and discuss accountability as part of a larger effort of which it is a part: Performance management of the education system.
