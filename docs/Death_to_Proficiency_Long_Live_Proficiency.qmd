...
- Spoiler alert from my first day at the conference: No one is satisfied with the current state of educational accountability systems.
- There seems to be broad agreement that change is needed. But there is no consensus on what that change should be.
- I, too, find the current accountability systems unsatisfactory—though likely for different reasons than most.
- For the past 20 years, for a variety of reasons, we have failed to effectively leverage high-quality state summative assessment data we work so hard to collect.
- In today's session, we will step back to reframe accountability as part of a broader performance management effort and examine how current accountability-driven data use hinders meaningful educational improvement.
